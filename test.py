...
def Perkenalan():
    st.balloons()
    st.header("KELOMPOK 5 PROJEK LPK 2024 ")
...
def Pendahuluan():  
    ...
    st.subheader("Di Era sekarang Mahasiswa Politeknik AKA Bogor membutuhkan suatu aplikasi yang ringkas untuk membantu dalam menghitung Bobot Molekul berserta ketidakpastiannya (U) untuk memenuhi keperluan pada Mata Kuliah Titrimetri. Aplikasi merupakan Teknologi yang berkembang pesat pada saat ini, kemajuan teknologi dalam membantu pengolahan data atau informasi yang tersedia.")
    ...
    st.write("1. Akurasi Tinggi: Dengan algoritma perhitungan yang canggih, aplikasi dapat memberikan hasil yang akurat dan dapat diandalkan, termasuk perhitungan ketidakpastian bobot molekul, yang penting untuk penelitian yang lebih presisi.")
    st.write("2. Pemahaman yang Lebih Baik: Pengguna dapat memahami sifat-sifat kimia dari zat tertentu dengan lebih baik melalui pemahaman bobot molekulnya, sehingga membantu dalam pengembangan produk dan pemecahan masalah dalam berbagai aplikasi industri.")
    ...
    st.write("1. Memberikan Akses yang Mudah: Aplikasi ini akan memberikan akses yang mudah bagi mahasiswa Politeknik AKA Bogor untuk mencari bobot molekul dari unsur kimia tertentu.")
    st.write("2. Menghitung Ketidakpastian: Aplikasi ini akan memungkinkan pengguna untuk menghitung ketidakpastian bobot molekul, yang penting untuk penelitian yang akurat dan dapat diandalkan.")
    ...
    st.subheader("Perhitungan Ketidakpastian Bobot Atom")
    st.write("Ketidakpastian (U) dalam perhitungan Bobot Atom yang dapat dihitung menggunakan persamaan:")
    st.latex(r'miu=U/K')
...
def Pencarian():
    st.subheader("Masukkan informasi di bawah untuk menemukan Bobot Atom dan Ketidakpastiannya:")
...
def Perhitungan():
    st.header('Perhitungan Ketidakpastian Bobot Molekul')
    st.subheader('Masukkan Informasi di bawah ini untuk Menghitung Ketidakpastian Bobot Molekul:')

    def hitung_nilai_x(U):
        return U / math.sqrt(3)

    # Input nilai U
    U = st.number_input('Masukkan nilai U (mg/mmol)', step=0.1)

    # Hitung nilai x
    x = hitung_nilai_x(U)

    # Tampilkan hasil
    st.write('Nilai ketidakpastiannya adalah:', x)
